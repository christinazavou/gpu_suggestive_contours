//
// Created by christina on 07-10-20.
//
...
int main(int argc, char *argv[])
{
    ...
    eglTerminate(eglDpy);
    return 0;
    // now run command: display -size 512x512 -depth 8 cmake-build-debug/fbodump.png
}
...
namespace render
{
    ...
    void init()
    {
        ...
        dumpbuf_fd = open("fbodump.png", O_CREAT|O_SYNC|O_RDWR, S_IRUSR|S_IWUSR);
        assert(-1 != dumpbuf_fd);
